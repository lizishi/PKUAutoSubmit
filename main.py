...
if __name__ == '__main__':
    ...
    parser.add_argument('--reason', type=str, help='出校原因, eg. 吃饭', default='入校上课')
    parser.add_argument('--destination', type=str, help='出校目的地, eg. 北京', default='北京')
    parser.add_argument('--track', type=str, help='出校轨迹, eg. 畅春园食堂', default='万柳-中关村e世界-燕园大厦')
    ...
    parser.add_argument('--street', type=str, help='入校前居住所在街道, eg. 燕园街道', default='海淀街道')
